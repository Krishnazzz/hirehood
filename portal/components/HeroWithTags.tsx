    ...
    >
      ...
      >
        ...
        {tags.map((tag, index) => {
          ...
          const depthMultiplier = isHovered ? 1.5 : 1;
          ...
          return (
            <Box
              ...
              sx={{
                ...
                left: `${tag.left}%`,
                top: `${tag.top}%`,
                transform: `translate(-50%, -50%) translate3d(${-mousePos.x * tag.depth * depthMultiplier}px, ${-mousePos.y * tag.depth * depthMultiplier}px, 0px)`,
